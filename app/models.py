...
class BaseModel(db.Model):
    ...
    created_at = db.Column(
        db.DateTime, default=lambda: datetime.now(tz=ZoneInfo("UTC")), nullable=False
    )
    updated_at = db.Column(
        db.DateTime, default=lambda: datetime.now(tz=ZoneInfo("UTC")),
        onupdate=lambda: datetime.now(tz=ZoneInfo("UTC")), nullable=False
    )
